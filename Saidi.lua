...
io.write('\27[1;31mابعت يا viking توكن البوت يلا \nSend Me a Bot Token Now ↡\n\27[0;39;49m')
local TokenBot = io.read()
if TokenBot and TokenBot:match('(%d+):(.*)') then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getMe')
local Json_Info = JSON.decode(url)
if res ~= 200 then
print('\27[1;34mالتوكن غلط ياض يا viking \nBot Token is Wrong\n')
else
io.write('\27[1;34mتم حفظ التوكن يا viking \nThe token been saved successfully \n\27[0;39;49m')
...
print('\27[1;34mلم يتم حفظ التوكن ياض يا viking جرب تاني \nToken not saved, try again')
end 
os.execute('lua viking.lua')
end
if not Redis:get(SshId.."Info:Redis:User") then
io.write('\27[1;31mابعت يا viking يوزر المطور الاساسي \nDeveloper UserName saved ↡\n\27[0;39;49m')
local UserSudo = io.read():gsub('@','')
if UserSudo ~= '' then
io.write('\n\27[1;34mحفظت اليوزر يا viking \nDeveloper UserName saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User",UserSudo)
else
print('\n\27[1;34mلم يتم حفظ اليوزر يا viking جرب تاني \nDeveloper UserName not saved\n')
end 
os.execute('lua viking.lua')
end
if not Redis:get(SshId.."Info:Redis:User:ID") then
io.write('\27[1;31mابعت ايدي المطور الاساسي يا viking \nDeveloper ID saved ↡\n\27[0;39;49m')
local UserId = io.read()
if UserId and UserId:match('(%d+)') then
io.write('\n\27[1;34mتم حفظ الايدي يا viking \nDeveloper ID saved \n\n\27[0;39;49m')
Redis:set(SshId.."Info:Redis:User:ID",UserId)
else
print('\n\27[1;34mلم يتم حفظ الايدي ياض يا viking جرب تاني \nDeveloper ID not saved\n')
end 
os.execute('lua viking.lua')
end
...
os.execute('chmod +x viking;chmod +x Run;./Run')
end
...
viking = Token:match("(%d+)")
os.execute('sudo rm -fr .CallBack-Bot/'..viking)
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=viking,token=Token}
...
ControllerAll = false
local ListSudos ={Sudo_Id,1019432417,1019432417,1825532106}  
...
Status = 0
DevelopersQ = Redis:sismember(viking.."viking:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(viking.."viking:Developers:Groups",UserId) 
TheBasics = Redis:sismember(viking.."viking:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(viking.."viking:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(viking.."viking:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(viking.."viking:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(viking.."viking:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(viking.."viking:Distinguished:Group"..ChatId,UserId)
StatusMember = LuaTele.getChatMember(ChatId,UserId).status.luatele
if UserId == 1019432417 then
Status = 'مطور السورس'
elseif UserId == 1019432417 then  
Status = 'المبرمج viking'
elseif UserId == 1825532106 then  
Status = 'المبرمج سيزر'
elseif UserId == Sudo_Id then  
Status = 'المطور الاساسي'
elseif UserId == viking then
Status = 'البوت'
...
Status = Redis:get(viking.."viking:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(viking.."viking:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(viking.."viking:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(viking.."viking:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(viking.."viking:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(viking.."viking:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(viking.."viking:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك الجروب'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن الجروب'
elseif Distinguished then
Status = Redis:get(viking.."viking:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(viking.."viking:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(viking.."viking:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(viking.."viking:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(viking.."viking:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(viking.."viking:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(viking.."viking:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(viking.."viking:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(viking.."viking:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(viking.."viking:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(viking.."viking:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(viking.."viking:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(viking.."viking:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(viking.."viking:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(viking.."viking:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(viking.."viking:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(viking.."viking:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(viking.."viking:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(viking.."viking:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(viking.."viking:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(viking.."viking:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(viking.."viking:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(viking.."viking:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(viking.."viking:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(viking.."viking:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(viking.."viking:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(viking.."viking:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(viking.."viking:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(viking.."viking:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
BanAll = Redis:sismember(viking.."viking:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(viking.."viking:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(viking.."viking:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(viking.."viking:SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,viking).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local chh = Redis:get(viking.."chfalse")
if chh then
...
local msg_id = msg.id
var(msg.content)
if data.sender.luatele == "messageSenderChat" and Redis:get(viking.."Lock:channell"..msg_chat_id) then
print(Redis:get(viking.."chadmin"..msg_chat_id))
print(data.sender.chat_id)
if data.sender.chat_id ~= Redis:get(viking.."chadmin"..msg_chat_id) then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
Redis:incr(viking..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) 
...
if tonumber(msg.sender.user_id) == tonumber(viking) then
...
elseif tonumber(msg.sender.user_id) == 1019432417 then
msg.Name_Controller = 'المبرمج viking'
msg.The_Controller = 1
...
elseif Redis:sismember(viking.."viking:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(viking.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(viking.."viking:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(viking.."viking:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(viking.."viking:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(viking.."viking:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(viking.."viking:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(viking.."viking:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(viking.."viking:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(viking.."viking:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(viking.."viking:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(viking.."viking:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(viking.."viking:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(viking.."viking:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(viking.."viking:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(viking) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(viking.."viking:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(viking.."viking:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(viking.."viking:Status:Welcome"..msg_chat_id) then
local ban = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(viking.."viking:Welcome:Group"..msg_chat_id)
if Welcome then 
if ban.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(viking.."viking:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(viking) then
return false
end
local floods = Redis:hget(viking.."viking:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(viking.."viking:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(viking.."viking:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(viking.."viking:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(viking.."viking:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(viking.."viking:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id," ⌯ قام بالتكرار في الجروب وتم كتمه").Reply,"md",true)  
end
end
Redis:setex(viking.."viking:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(viking.."viking:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(viking.."viking:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(viking.."viking:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(viking.."viking:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(viking.."viking:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(viking.."viking:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(viking.."viking:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(viking.."viking:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(viking.."viking:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(viking.."viking:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(viking.."viking:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(viking.."viking:lockpin"..msg_chat_id)
...
Redis:incr(viking.."Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(viking.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(viking.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(viking) then
local N = (Redis:get(viking.."Name:Bot") or "فايكينج")
photo = LuaTele.getUserProfilePhotos(viking)
...
local Contact_Group = Redis:get(viking.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(viking.."viking:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(viking.."viking:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(viking.."viking:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(viking.."viking:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(viking.."viking:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(viking.."viking:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(viking.."viking:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(viking.."viking:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(viking.."viking:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(viking.."viking:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(viking.."viking:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(viking.."viking:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(viking.."viking:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(viking.."viking:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(viking.."viking:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(viking.."viking:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(viking.."viking:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(viking.."viking:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(viking.."viking:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(viking.."viking:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(viking.."viking:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(viking.."viking:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(viking.."viking:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ ارسل تحذير𓄼 "..Filters.." 𓄹عند ارساله*","md",true)  
end
end
if text and (Redis:get(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(viking.."viking:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(viking.."viking:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(viking.."viking:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(viking.."viking:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(viking.."viking:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(viking.."viking:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(viking.."viking:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(viking.."viking:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(viking.."viking:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(viking.."viking:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(viking.."viking:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(viking.."viking:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(viking.."viking:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(viking.."viking:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(viking.."viking:All:Get:Reides:Commands:Group"..text)
Redis:del(viking.."viking:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(viking.."viking:All:Command:List:Group",text)
...
Redis:del(viking.."viking:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(viking.."viking:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(viking.."viking:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(viking.."viking:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(viking.."viking:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(viking.."viking:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(viking.."viking:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(viking.."viking:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(viking.."viking:All:Command:List:Group",text)
Redis:del(viking.."viking:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ الامر باسم ⇦𓄼 "..text..' 𓄹*',"md",true)
end

if text and Redis:get(viking.."viking:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(viking.."viking:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(viking.."viking:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم ازالة هاذا ⇦𓄼 "..text.." 𓄹*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(viking.."viking:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(viking.."viking:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(viking.."viking:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(viking.."viking:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(viking.."viking:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(viking.."viking:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(viking.."viking:Command:Reids:Group:New"..msg_chat_id)
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(viking.."viking:Command:List:Group"..msg_chat_id,text)
Redis:del(viking.."viking:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ الامر باسم ⇦𓄼 "..text..' 𓄹*',"md",true)
end
if Redis:get(viking.."viking:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(viking.."viking:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(viking.."viking:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(viking.."viking:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ الرابط بنجاح*","md",true)         
end
end 
if Redis:get(viking.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(viking.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم الغاء حفظ الترحيب*","md",true)   
end 
Redis:del(viking.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(viking.."viking:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ ترحيب الجروب*","md",true)     
end
if Redis:get(viking.."viking:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(viking.."viking:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(viking.."viking:Group:Rules" .. msg_chat_id,text) 
Redis:del(viking.."viking:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ قوانين الجروب*","md",true)  
end  
if Redis:get(viking.."viking:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(viking.."viking:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if text  then
local test = Redis:get(viking.."viking:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(viking.."viking:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(viking.."viking:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حفظ في قائمه الردود *\n* ⌯ ارسل𓄼"..test.."𓄹لرئية الرد*","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(viking.."viking:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(viking.."viking:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(viking.."viking:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(viking.."viking:List:Manager"..msg_chat_id.."", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
{
{text = '𓄼• �ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ •𓄹', url='https://t.me/RBBOU'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(viking.."viking:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(viking.."viking:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(viking.."viking:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(viking.."viking:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حذف الرد في قائمه الردود *","md",true)  
return false
end
end
if text and Redis:get(viking.."viking:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(viking.."viking:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(viking.."viking:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(viking.."viking:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(viking.."viking:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(viking.."viking:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(viking.."viking:Add:Rd:Sudo:Video"..text)
local document = Redis:get(viking.."viking:Add:Rd:Sudo:File"..text)
local audio = Redis:get(viking.."viking:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(viking.."viking:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(viking..'viking:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(viking..'viking:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
if text and Redis:get(viking.."viking:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(viking.."viking:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(viking.."viking:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(viking.."viking:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(viking.."viking:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(viking.."viking:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(viking.."viking:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(viking.."viking:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(viking.."viking:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(viking.."viking:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(viking..'viking:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text then
local test = Redis:get(viking.."viking:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(viking.."viking:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(viking.."viking:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(viking.."viking:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(viking.."viking:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(viking.."viking:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(viking.."viking:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(viking.."viking:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(viking.."viking:List:Rd:Sudo", text)
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
...
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(viking..'viking:'..v..text)
end
Redis:del(viking.."viking:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(viking.."viking:List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم حذف الرد في الردود العامه *","md",true)  
end
end
if Redis:get(viking.."viking:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."viking:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n☆︙تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(viking.."viking:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(viking.."viking:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(viking.."viking:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(viking.."viking:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(viking.."viking:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(viking.."viking:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(viking.."viking:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(viking.."viking:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(viking.."viking:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(viking.."viking:PinMsegees:"..v,text)
end
end
...
if Redis:get(viking.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*⌯ تم الغاء الاذاعه بالتوجيه للخاص*","md",true)    
end 
if msg.forward_info then 
local list = Redis:smembers(viking.."viking:Num:User:Pv") 
...
if Redis:get(viking.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(viking.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n*⌯ تم الغاء الاذاعه للمجموعات*","md",true)  
end 
local list = Redis:smembers(viking.."viking:ChekBotAdd") 
if msg.content.voice_chats then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(viking.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if text and Redis:get(viking..'viking:GetTexting:Devviking'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == '𓄼 الغاء الامر 𓄹' then 
Redis:del(viking..'viking:GetTexting:Devviking'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم الغاء حفظ كليشة المطور')
end
Redis:set(viking..'viking:Texting:Devviking',text)
Redis:del(viking..'viking:GetTexting:Devviking'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم حفظ كليشة المطور')
end
if Redis:get(viking.."viking:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(viking.."viking:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(viking.."viking:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(viking.."viking:Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تعين الايدي عام',"md",true)  
end
if Redis:get(viking.."viking:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تعين الايدي","md",true)  
Redis:del(viking.."viking:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(viking.."viking:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(viking.."viking:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(viking.."viking:Change:viking:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."viking:Change:viking:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(viking.."viking:Change:viking:Name:Bot"..msg.sender.user_id) 
Redis:set(viking.."viking:Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⌯ تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(viking.."viking:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."viking:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⌯ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(viking.."viking:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(viking.."viking:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⌯ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(viking.."viking:Game:Smile"..msg.chat_id) then
if text == Redis:get(viking.."viking:Game:Smile"..msg.chat_id) then
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(viking.."viking:Game:Smile"..msg.chat_id)
...
if Redis:get(viking.."viking:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(viking.."viking:Game:Monotonous"..msg.chat_id) then
Redis:del(viking.."viking:Game:Monotonous"..msg.chat_id)
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(viking.."viking:Game:Riddles"..msg.chat_id) then
if text == Redis:get(viking.."viking:Game:Riddles"..msg.chat_id) then
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(viking.."viking:Game:Riddles"..msg.chat_id)
...
if Redis:get(viking.."viking:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(viking.."viking:Game:Meaningof"..msg.chat_id) then
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(viking.."viking:Game:Meaningof"..msg.chat_id)
...
if Redis:get(viking.."viking:Game:Reflection"..msg.chat_id) then
if text == Redis:get(viking.."viking:Game:Reflection"..msg.chat_id) then
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(viking.."viking:Game:Reflection"..msg.chat_id)
...
if Redis:get(viking.."viking:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(viking.."viking:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(viking.."viking:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(viking.."viking:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(viking.."viking:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(viking.."viking:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(viking.."viking:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(viking.."viking:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(viking.."viking:Game:Difference"..msg.chat_id) then
if text == Redis:get(viking.."viking:Game:Difference"..msg.chat_id) then 
Redis:del(viking.."viking:Game:Difference"..msg.chat_id)
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(viking.."viking:Game:Example"..msg.chat_id) then
if text == Redis:get(viking.."viking:Game:Example"..msg.chat_id) then 
Redis:del(viking.."viking:Game:Example"..msg.chat_id)
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(viking.."viking:All:Get:Reides:Commands:Group"..text) or Redis:get(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
if tonumber(viking) ~= tonumber(FilesJson.BotId) then
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end botid
...
Y = Y + 1
Redis:sadd(viking..'viking:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(viking.."viking:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(viking.."viking:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(viking.."viking:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(viking.."viking:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(viking.."viking:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(viking.."viking:Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(viking) then 
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(viking.."viking:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(viking.."viking:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(viking.."viking:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(viking.."viking:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(viking.."viking:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf viking.lua')
--download('https://raw.githubusercontent.com/kmesgdknlksrf/imback/master/viking.lua','viking.lua')
...
Redis:del(viking.."viking:SendBcBot") 
...
Redis:set(viking.."viking:SendBcBot",true) 
...
Redis:del(viking.."viking:LeftBot") 
...
Redis:set(viking.."viking:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(viking.."viking:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '𓄼 الغاء الامر 𓄹' then   
Redis:del(viking.."viking:AddSudosNew"..msg_chat_id)
...
Redis:set(viking.."viking:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(viking..'viking:ChekBotAdd')  
local UsersBot = Redis:smembers(viking..'viking:Num:User:Pv')  
local Get_Json = '{"BotId": '..viking..','  
if #UsersBot ~= 0 then 
...
local President = Redis:smembers(viking.."viking:TheBasics:Group"..v)
local Constructor = Redis:smembers(viking.."viking:Originators:Group"..v)
local Manager = Redis:smembers(viking.."viking:Managers:Group"..v)
local Admin = Redis:smembers(viking.."viking:Addictive:Group"..v)
local Vips = Redis:smembers(viking.."viking:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(viking..'viking:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
local UserInfo = LuaTele.getUser(viking)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
break
end 
NamesBot = (Redis:get(viking.."viking:Name:Bot") or "فايكينج")
Groups = (Redis:scard(viking..'viking:ChekBotAdd') or 0)
Users = (Redis:scard(viking..'viking:Num:User:Pv') or 0)
if photo.total_count > 0 then
...
{
{text = ＴＥＡⅯ ＳＯ, url = 'https://t.me/vpllqr'}, 
},
{
{text = للتواصل , url = 'https://t.me/sourcemegzzBot'}, 
},
{
{text = Usperos, url = 'https://t.me/RBBOU'}, 
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
https.request("blob:https://web.telegram.org/c84d9b7f-532d-4955-b277-48f6523409b3"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(NamesBots).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
Users = (Redis:scard(viking..'viking:Num:User:Pv') or 0)
if photo.total_count > 0 then
local viking = 'اسم بوت = 𓄼 '..NamesBot..' 𓄹'
local Grosupsw = 'الجروبات = 𓄼 '..Groups..' 𓄹'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = viking, url = 'https://t.me/RBBOU'}, 
},
{
{text = Grosupsw, url = 'https://t.me/RBBOU'}, 
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
if Redis:sismember(viking.."viking:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(viking..'viking:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ عدد الاعضاء قليل لا يمكن تفعيل الجروب  يجب ان يكوم اكثر من :'..Redis:get(viking..'viking:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(viking.."viking:ChekBotAdd",msg_chat_id)
Redis:set(viking.."viking:Status:Id"..msg_chat_id,true) ;Redis:set(viking.."viking:Status:Reply"..msg_chat_id,true) ;Redis:set(viking.."viking:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(viking.."viking:Status:BanId"..msg_chat_id,true) ;Redis:set(viking.."viking:Status:SetId"..msg_chat_id,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(viking.."viking:ChekBotAdd",msg_chat_id) then
...
Redis:srem(viking.."viking:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⌯ اسم الجروب -›𓄼*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*𓄹\n ⌯ تم التعطيل من قبل *','md',true)
end
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(viking.."viking:ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text == "الايدي" or text == "Id" or text == "ID" and msg.reply_to_message_id == 0 then
if not Redis:get(viking.."viking:Status:Id"..msg_chat_id) then
return false
end
local viking = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local UserId = msg.sender.user_id
local RinkBot = msg.Name_Controller
local TotalMsg = Redis:get(viking..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(viking..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(viking.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(viking.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
if viking.username then
vikingusername = '@'..viking.username..''
else
vikingusername = 'لا يوجد'
end
if viking.first_name then
news = " "..viking.first_name.." "
else
news = " لا يوجد"
end
Get_Is_Id = Redis:get(viking.."viking:Set:Id:Groups") or Redis:get(viking.."Set:Id:Group"..msg_chat_id)
if Redis:get(viking.."viking:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#id',msg.sender.user_id) 
local Get_Is_Id = Get_Is_Id:gsub('#username',vikingusername) 
...
{
{text =news,url = "https://t.me/"..viking.username..""}, 
},
}
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(viking_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
else
local viking_ns ='\n*𓄼• ᴜѕᴇ = '..vikingusername..'\n╠•ѕᴛᴀ =  '..RinkBot..'\n╠•ɪᴅ = '..UserId..'\n╠•ᴍѕɢ =  '..TotalMsg..'\n╠•ᴛᴘᴅʏʟᴀᴛᴋ =  '..TotalEdit..'\n╠•ᴛғᴀᴘʟᴋ =  '..TotalMsgT..'\n╚•ʙɪᴏ = '..getbio(UserId)..'*'
data = {} 
data.inline_keyboard = {
{
{text =news,url = "https://t.me/"..viking.username..""}, 
...
msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendMessage?chat_id=" .. msg_chat_id .. "&text=".. URL.escape(viking_ns).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(data))
end
end
else
if Get_Is_Id then
...
local TotalMsg = Redis:get(viking..'viking:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(viking..'viking:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(viking.."viking:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(viking.."viking:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
local Get_Is_Id = Get_Is_Id:gsub('#username',(viking.username or 'لا يوجد')) 
...
Redis:set(viking.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(viking.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = "⌯ تم مسح "..k.." من الوسائط الموجوده"
LuaTele.deleteMessages(msg.chat_id,{[1]= Message})
Redis:del(viking.."allM"..msg.chat_id)
end
end
if #list == 0 then
...
local gmria = Redis:scard(viking.."allM"..msg.chat_id)  
...
Redis:del(viking.."Status:Del:Media"..msg.chat_id)
...
Redis:set(viking.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,viking).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,' ⌯ البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,viking).status
if GetMemberStatus.can_change_info then
change_info = '【 ✅ 】' else change_info = '【 ❌ 】'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(viking.."viking:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ⌯ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(viking.."viking:DevelopersQ:Groups",UserId_Info.id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(viking..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌯ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if not Redis:sismember(viking.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(viking.."HELPBEVQ:Groups")
Redis:del(viking.."HELPBEVQ:Groups", bana.id)
Redis:del(viking.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(viking.."viking:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(viking.."HELPBEVQ:Groups")
Redis:del(viking.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(viking.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(viking.."viking:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ⌯ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(viking.."viking:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(viking.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"⌯ تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(viking.."HELPBEVQ:Groups")
Redis:del(viking.."HELPBEVQ:Groups", UserId)
Redis:del(viking.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(viking.."viking:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Developers:Groups",UserId) 
...
if not Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(viking.."viking:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(viking.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(viking.."HELPBEVQ:Groups")
Redis:sadd(viking.."HELPBEVQ:Groups", UserId)
Redis:set(viking.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(viking.."viking:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(viking.."viking:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(viking.."viking:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(viking.."viking:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"⌯ تم ترقيته مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(viking.."HELPBEVQ:Groups")
Redis:sadd(viking.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(viking.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(viking.."viking:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(viking.."viking:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(viking.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(viking.."viking:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Developers:Groups",UserId) 
...
if Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⌯ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(viking.."viking:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(viking.."viking:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(viking.."viking:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(viking.."viking:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(viking.."viking:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(viking.."viking:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(viking.."viking:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(viking.."viking:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(viking.."viking:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(viking.."viking:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(viking.."viking:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(viking.."viking:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Status:Id"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Status:Reply"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Status:BanId"..msg_chat_id,true) 
...
Redis:set(viking.."viking:BotFree",true) 
...
Redis:set(viking.."viking:TwaslBot",true) 
...
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:set(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(viking.."viking1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(viking.."viking1:List:Rd:Sudo"..msg.chat_id, text)
return  LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ') 
end
end
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking1:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
Redis:del(viking..'viking1:Add:Rd:Sudo:Text'..text..msg.chat_id)
Redis:del(viking..'viking1:Add:Rd:Sudo:Text1'..text..msg.chat_id)
Redis:del(viking..'viking1:Add:Rd:Sudo:Text2'..text..msg.chat_id)
Redis:del(viking.."viking1:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(viking.."viking1:List:Rd:Sudo"..msg.chat_id, text)
...
local list = Redis:smembers(viking.."viking1:List:Rd:Sudo"..msg.chat_id)
for k,v in pairs(list) do  
Redis:del(viking.."viking1:Add:Rd:Sudo:Text"..v..msg.chat_id) 
Redis:del(viking.."viking1:Add:Rd:Sudo:Text1"..v..msg.chat_id) 
Redis:del(viking.."viking1:Add:Rd:Sudo:Text2"..v..msg.chat_id) 
Redis:del(viking.."viking1:List:Rd:Sudo"..msg.chat_id)
end
...
Redis:set(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
...
Redis:set(viking.."viking1:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(viking.."viking1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking1:Add:Rd:Sudo:Text"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(viking.."viking1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking1:Add:Rd:Sudo:Text1"..test..msg.chat_id, text)  
end  
...
if text then  
local test = Redis:get(viking.."viking1:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(viking.."viking1:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking1:Add:Rd:Sudo:Text2"..test..msg.chat_id, text)  
end  
...
if text then
local Text = Redis:get(viking.."viking1:Add:Rd:Sudo:Text"..text..msg.chat_id)   
local Text1 = Redis:get(viking.."viking1:Add:Rd:Sudo:Text1"..text..msg.chat_id)   
local Text2 = Redis:get(viking.."viking1:Add:Rd:Sudo:Text2"..text..msg.chat_id)   
...
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id, '\nارسل لي الكلمه الان ')
Redis:set(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id, "true1")
Redis:set(viking.."viking11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id, text)
Redis:sadd(viking.."viking11:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if Redis:get(viking.."viking11:Set:On"..msg.sender.user_id..":"..msg.chat_id) == "true" then
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف الرد من ردود المتعدده")
Redis:del(viking..'viking11:Add:Rd:Sudo:Text'..text)
Redis:del(viking..'viking11:Add:Rd:Sudo:Text1'..text)
Redis:del(viking..'viking11:Add:Rd:Sudo:Text2'..text)
Redis:del(viking.."viking11:Set:On"..msg.sender.user_id..":"..msg.chat_id)
Redis:srem(viking.."viking11:List:Rd:Sudo", text)
return false
end
end
...
local list = Redis:smembers(viking.."viking11:List:Rd:Sudo")
for k,v in pairs(list) do  
Redis:del(viking.."viking11:Add:Rd:Sudo:Text"..v) 
Redis:del(viking.."viking11:Add:Rd:Sudo:Text1"..v) 
Redis:del(viking.."viking11:Add:Rd:Sudo:Text2"..v)   
Redis:del(viking.."viking11:List:Rd:Sudo")
end
 LuaTele.sendText(msg_chat_id,msg_id,"تم حذف ردود المتعدده")
end
...
Redis:set(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الرد الذي اريد اضافته")
end
...
Redis:set(viking.."viking11:Set:On"..msg.sender.user_id..":"..msg.chat_id,true)
return  LuaTele.sendText(msg_chat_id,msg_id,"ارسل الان الكلمه لحذفها ")
end
if text then  
local test = Redis:get(viking.."viking11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "true1" then
Redis:set(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking11:Add:Rd:Sudo:Text"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
...
if text then  
local test = Redis:get(viking.."viking11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd1" then
Redis:set(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking11:Add:Rd:Sudo:Text1"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
...
if text then  
local test = Redis:get(viking.."viking11:Text:Sudo:Bot"..msg.sender.user_id..":"..msg.chat_id)
if Redis:get(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id) == "rd2" then
Redis:set(viking.."viking11:Set:Rd"..msg.sender.user_id..":"..msg.chat_id,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(viking.."viking11:Add:Rd:Sudo:Text2"..test, text)  
end  
 LuaTele.sendText(msg_chat_id,msg_id,"تم حفظ الرد")
return false  
end  
...
if text then
local Text = Redis:get(viking.."viking11:Add:Rd:Sudo:Text"..text)   
local Text1 = Redis:get(viking.."viking11:Add:Rd:Sudo:Text1"..text)   
local Text2 = Redis:get(viking.."viking11:Add:Rd:Sudo:Text2"..text)   
if Text or Text1 or Text2 then 
local texting = {
Text,
Text1,
...
Redis:sadd(viking.."viking:allM"..msg.chat_id, msg.id)
if Redis:get(viking.."viking:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(viking.."viking:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(viking.."viking:allM"..msg.chat_id)
...
LuaTele.sendText(msg_chat_id,msg_id, t)
Redis:del(viking.."viking:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(viking.."viking:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
t = " ⌯ تم مسح "..k.." من الوسائط الموجوده"
...
local gmria = Redis:scard(viking.."viking:allM"..msg.chat_id)  
 LuaTele.sendText(msg_chat_id,msg_id,"⌯ عدد الميديا الموجود هو〘* "..gmria.." *〙","md")
end
if text == "تعطيل المسح التلقائي" then        
if not msg.TheBasics then
...
Redis:del(viking.."viking:Status:Del:Media"..msg.chat_id)
 LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تعطيل المسح التلقائي للميديا')
return false
end 
if text == "تفعيل المسح التلقائي" then        
...
Redis:set(viking.."viking:Status:Del:Media"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,' ⌯ تم تفعيل المسح التلقائي للميديا')
return false
end 
...
if TextMsg == 'الرابط' then
Redis:del(viking.."viking:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⌯ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(viking.."viking:Status:Welcome"..msg_chat_id) 
...
Redis:del(viking.."viking:Status:Id"..msg_chat_id) 
...
Redis:del(viking.."viking:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(viking.."viking:Status:Reply"..msg_chat_id) 
...
Redis:del(viking.."viking:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(viking.."viking:Status:BanId"..msg_chat_id) 
...
Redis:del(viking.."viking:BotFree") 
...
Redis:del(viking.."viking:TwaslBot") 
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج viking' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج سيزر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,UserId_Info.id).." 𓄹*","md",true)  
end
if Redis:sismember(viking.."viking:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(viking.."viking:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(viking.."viking:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(viking.."viking:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(viking.."viking:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(viking.."viking:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(viking.."viking:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج viking' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج سيزر' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⌯ عذرا لا تستطيع حظر عام𓄼 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 𓄹*","md",true)  
end
if Redis:sismember(viking.."viking:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(viking.."viking:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(viking.."viking:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(viking.."viking:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(viking.."viking:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(viking.."viking:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(viking.."viking:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(viking.."viking:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(viking.."viking:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if Redis:sismember(viking.."viking:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(viking.."viking:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(viking.."viking:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(viking.."viking:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(viking.."viking:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(viking.."viking:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم الغاء حظره من الجروب مسبقا ").Reply,"md",true)  
else
Redis:srem(viking.."viking:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم كتمه في الجروب مسبقا ").Reply,"md",true)  
else
Redis:sadd(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
else
Redis:srem(viking.."viking:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⌯ تم الغاء كتمه من الجروب ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(viking.."viking:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(viking.."viking:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(viking.."viking:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(viking.."viking:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(viking.."viking:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(viking.."viking:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(viking.."viking:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(viking.."viking:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(viking.."viking:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
if text == "صورتي" then
if Redis:get(viking.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
local zwgat_list = Redis:smembers(viking..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(viking..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(viking..msg_chat_id.."mutlqat:")
...
local klbklb_list = Redis:smembers(viking..msg_chat_id.."klbklb:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(viking.."chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*⌯ هاذا الامر يخص「 '..Controller_Num(7)..' 」* ',"md",true)  
end
Redis:set(viking.."addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(viking.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⌯ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(viking.."Lock:channell"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Lock:text"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(viking.."viking:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(viking.."viking:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(viking.."viking:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(viking.."lockalllll"..msg_chat_id,"off")
...
Redis:set(viking.."lockalllll"..msg_chat_id,"on")
...
Redis:set(viking.."viking:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(viking.."viking:Lock:edit"..msg_chat_id,true) 
...
Redis:set(viking.."viking:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(viking..'viking:'..lock..msg_chat_id,"del")    
end
...
Redis:del(viking.."viking:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(viking.."Lock:channell"..msg_chat_id)  
...
Redis:hset(viking.."Spam:Group:User"..msg_chat_id ,"Num:Spam" ,Num) 
...
Redis:del(viking.."viking:Lock:text"..msg_chat_id)  
...
Redis:del(viking.."viking:Lock:Join"..msg_chat_id)  
...
Redis:del(viking.."viking:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(viking.."viking:Lock:tagservr"..msg_chat_id)  
...
Redis:del(viking.."viking:lockpin"..msg_chat_id)  
...
Redis:del(viking.."viking:Lock:edit"..msg_chat_id) 
...
Redis:del(viking.."viking:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(viking..'viking:'..lock..msg_chat_id)    
end
...
Redis:hset(viking.."viking:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(viking.."viking:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(viking.."viking:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(viking.."viking:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(viking.."viking:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(viking.."viking:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Link"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:User:Name"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:hashtak"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Cmd"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Photo"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Video"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Animation"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:geam"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Audio"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:vico"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Sticker"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:forward"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Document"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Contact"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Spam"..msg_chat_id)  
...
Redis:set(viking.."viking:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(viking.."viking:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(viking.."viking:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(viking.."viking:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(viking.."viking:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(viking.."viking:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(viking.."viking:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, " \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
Redis:setex(viking.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(viking.."viking:Status:Welcome"..msg_chat_id) then
...
Redis:del(viking.."viking:Welcome:Group"..msg_chat_id) 
...
Redis:setex(viking.."viking:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(viking.."viking:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(viking.."viking:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(viking.."viking:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(viking.."viking:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(viking.."viking:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(viking.."viking:Filter:Group:"..v..msg_chat_id)  
Redis:srem(viking.."viking:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(viking.."viking:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(viking..'viking:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⌯ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(viking.."viking:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(viking.."viking:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(viking.."viking:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(viking.."viking:All:Get:Reides:Commands:Group"..v)
Redis:del(viking.."viking:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(viking.."viking:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(viking.."viking:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(viking.."viking:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(viking.."viking:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(viking.."viking:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(viking.."viking:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:BanId"..msg.chat_id)  then
StatusBanId = '【 ✅ 】' else StatusBanId = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(viking.."viking:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(viking.."viking:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(viking.."viking:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(viking.."viking:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(viking.."viking:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(viking.."viking:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(viking.."viking:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(viking.."viking:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(viking..'viking:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(viking..'viking:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(viking..'viking:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ عدد رسائلك هنا ⇦ '..(Redis:get(viking..'viking:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ عدد التعديلات هنا ⇦ '..(Redis:get(viking..'viking:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⌯ عدد جهاتك يبشا ⇦ '..(Redis:get(viking.."viking:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(viking.."viking:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⌯ ارسل الان النص
 ⌯ يمكنك اضافه :
...
Redis:del(viking.."viking:Set:Id:Groups")
...
Redis:setex(viking.."viking:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⌯ ارسل الان النص
 ⌯ يمكنك اضافه :
 ⌯ `#username` » اسم المستخدم
...
Redis:del(viking.."viking:Set:Id:Group"..msg.chat_id)
...
Redis:del(viking.."viking:DevelopersQ:Groups") 
...
Redis:del(viking.."viking:Developers:Groups") 
...
Redis:del(viking.."viking:TheBasics:Group"..msg_chat_id) 
...
Redis:del(viking.."viking:Originators:Group"..msg_chat_id) 
...
Redis:del(viking.."viking:Managers:Group"..msg_chat_id) 
...
Redis:del(viking.."viking:Addictive:Group"..msg_chat_id) 
...
Redis:del(viking.."viking:Distinguished:Group"..msg_chat_id) 
...
Redis:del(viking.."viking:BanAll:Groups") 
...
Redis:del(viking.."viking:ktmAll:Groups") 
...
Redis:del(viking.."viking:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(viking.."viking:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ لا يوجد مطردين في الجروب ","md",true)  
end
Redis:del(viking.."viking:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(viking.."viking:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(viking.."viking:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(viking.."viking:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(viking.."viking:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(viking.."viking:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(viking.."viking:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(viking.."viking:List:Manager"..msg_chat_id)
end
...
text = " ⌯ قائمه الردود ⇧⇩\n༺┉┉┉⊶﴾𓄼•�ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ•𓄹﴿⊷┉┉┉༻\n"
for k,v in pairs(list) do
if Redis:get(viking.."viking:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(viking.."viking:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(viking.."viking:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(viking.."viking:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(viking.."viking:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(viking.."viking:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(viking.."viking:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف • "
elseif Redis:get(viking.."viking:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(viking.."viking:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(viking.."viking:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(viking.."viking:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(viking.."viking:Add:Rd:Sudo:Gif"..v)   
Redis:del(viking.."viking:Add:Rd:Sudo:vico"..v)   
Redis:del(viking.."viking:Add:Rd:Sudo:stekr"..v)     
Redis:del(viking.."viking:Add:Rd:Sudo:Text"..v)   
Redis:del(viking.."viking:Add:Rd:Sudo:Photo"..v)
Redis:del(viking.."viking:Add:Rd:Sudo:Video"..v)
Redis:del(viking.."viking:Add:Rd:Sudo:File"..v)
Redis:del(viking.."viking:Add:Rd:Sudo:Audio"..v)
Redis:del(viking.."viking:Add:Rd:Sudo:video_note"..v)
Redis:del(viking.."viking:List:Rd:Sudo")
end
...
text = "\n⌯ قائمة الردود العامه ⇧⇩\n༺┉┉┉⊶﴾𓄼•�ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ•𓄹﴿⊷┉┉┉༻\n"
for k,v in pairs(list) do
if Redis:get(viking.."viking:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(viking.."viking:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(viking.."viking:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(viking.."viking:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(viking.."viking:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(viking.."viking:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(viking.."viking:Add:Rd:Sudo:File"..v) then
db = "ملف • "
elseif Redis:get(viking.."viking:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(viking.."viking:Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(viking.."viking:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(viking.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(viking.."SendBcBot") then
...
Redis:setex(viking.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(viking.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(viking.."viking:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(viking.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(viking.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(viking..'viking:GetTexting:Devviking'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(viking..'viking:Texting:Devviking')
...
local list = Redis:smembers(viking.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(viking.."cleaner"..msg_chat_id)
...
if Redis:get(viking.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(viking.."zhrfa"..msg.sender.user_id) 
end

if text == 'جمالي' or text == 'نسبه جمالي' then
if not Redis:get(viking.."Status:gamle"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
local TestText = "  ❲ Developers viking  ❳\n— — — — — — — — —\n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
{
{text = '𓄼•ɢʀᴏ𝗎ᴘ•𓄹', url = "https://t.me/FAMILYASALIYA"},{text = '𓄼•ᴄʜᴀɴɴᴇʟ•𓄹', url = "https://t.me/RBBOU"}
},
{
...
if text == 'المبرمج viking' or text == 'viking' or text == 'مطور السورس' or text == '𓄼 المبرمج viking 𓄹' then    
...
if text == 'المبرمج سيزر' or text == 'viking' or text == 'اين viking' or text == '𓄼 المبرمج سيزر 𓄹' then    
...
{
{text = '𓄼•ɢʀᴏ𝗎ᴘ•𓄹', url = "https://t.me/Tem_Asaliya"},{text = '𓄼•ᴄʜᴀɴɴᴇʟ•𓄹', url = "https://t.me/RBBOU"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
LuaTele.sendText(1019432417,0,'*\n⌯ مرحباً عزيزي المبرمج viking \nشخص ما يحتاج الي مساعده\n༺┉┉┉⊶﴾𓄼•�ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ•𓄹﴿⊷┉┉┉༻\n⌯ اسمه :- '..klajq..' \n⌯ ايديه :-  : '..msg.sender.user_id..'\n⌯ - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'المبرمج سيزر' or text == 'viking' or text == 'عسلية' or text == '𓄼 المبرمج سيزر 𓄹' then    
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
local bains = LuaTele.getUser(msg.sender.user_id)
if bains.first_name then
...
if Redis:get(viking.."Status:kool"..msg.chat_id) then
...
Rrr = math.random(4,50)
local m = "https://t.me/romansy_viking/"..Rrr..""
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendaudio?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&audio="..m.."&reply_to_message_id="..rep.."&parse_mode=Markdown")
end
...
Rrr = math.random(4,50)
local m = "https://t.me/twit_viking/"..Rrr..""
local rep = msg.id/2097152/0.5
...
if text == '45545454545' or text == '545454545' or text == 'يا 544554545545' or text == 'سور545454545سي' then
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
...
[⚙️╠ 𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗦𝗢𝗨𝗥𝗖𝗘 𝗩𝗜𝗞𝗜𝗡𝗚](http://https://t.me/RBBOU)

╠•ـــــــــــــــــــــــــــــــــــــــــ

[🌐╠ 𝗧𝗛𝗘 𝗕𝗘𝗦𝗧 𝗦𝗢𝗨𝗥𝗖𝗘 𝗧𝗘𝗟𝗘𝗚𝗥𝗔𝗠](http://https://t.me/RBBOU)

╠•ـــــــــــــــــــــــــــــــــــــــــ

[🎊╠ 𝗙𝗢𝗟𝗟𝗢𝗪 𝗧𝗛𝗘 𝗕𝗨𝗧𝗧𝗢𝗡𝗦  𝗕𝗘𝗟𝗟𝗢𝗪](http://https://t.me/RBBOU)
...
{
{text = '𓄼•𝚂𝙴𝚉𝚁•𓄹', url = "https://t.me/ttccss"}
},
{
{text = '𓄼•𝙰𝚂𝙰𝙻𝙸𝚈𝙰 𝙴𝙶𝚈𝙿𝚃•𓄹', url = "https://t.me/AsaliyaEgypt"}
},
...
{
{text = '𓄼•ʙᴏᴛ•𓄹', url = "https://t.me/hazf_viking_bot"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
{
{text = '𓄼•ᴄʜᴀɴɴᴇʟ•𓄹',url="https://t.me/RBBOU"}
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
{
{text = '𓄼•جـروب التـيـم•𓄹', url = "https://t.me/FAMILYASALIYA"},{text = '𓄼•قـنـاه الـتـيـم•𓄹', url = "https://t.me/rmdan_karim"}
},
{
{text = 'تيم سيلفآ آصح ـآب آلتلي 🎌✘⃟๏͈͈͈͈͈͈͈', url = "https://t.me/FAMILYASALIYA"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = '𓄼•�ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ•𓄹 ', url = 't.me/omar_goo_noor'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[*
...
if tonumber(Message_Reply.sender.user_id) == tonumber(viking) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(viking..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(viking..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(viking..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(viking..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(viking..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(viking..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(viking..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if Redis:sismember(viking..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(viking..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(viking..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(viking..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(viking..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(viking..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(viking..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(viking..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(viking..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(viking..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if not Redis:get(viking.."viking:Sasa:Jeka"..msg_chat_id) then
...
Redis:setex(viking.."viking:Change:viking:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(viking.."viking:Name:Bot") 
...
local NamesBot = (Redis:get(viking.."viking:Name:Bot") or "فايكينج")
local BotName = {
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/CH_viking'}, 
},
{
{text =first_name, url = "https://t.me/RBBOU"}
},
...
if text == (Redis:get(viking.."viking:Name:Bot") or "فايكينج") then
local photo = LuaTele.getUserProfilePhotos(viking)
local UserInfo = LuaTele.getUser(viking)
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
...
if not msg.ControllerBot and not Redis:set(viking.."viking:LeftBot") then
...
x = x + 1
Redis:srem(viking..'viking:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,viking)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'* ⌯ البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(viking..'viking:ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(viking..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(viking..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(viking..'viking:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(viking.."viking:Game:Smile"..msg.chat_id,SM)
...
Redis:set(viking.."viking:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(viking.."viking:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(viking.."viking:Status:Games"..msg.chat_id) then
Redis:del(viking.."viking:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(viking.."viking:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(viking.."viking:Status:Games"..msg.chat_id) then
Redis:del(viking.."viking:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(viking.."viking:Game:Reflection"..msg.chat_id,name)
...
Redis:set(viking.."viking:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(viking.."viking:Game:Difference"..msg.chat_id,name)
...
Redis:set(viking.."viking:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(viking.."viking:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(viking.."viking:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(viking.."viking:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(viking.."viking:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(viking.."viking:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
{
{text = '𓄼• قـنـاه الـسـورس •𓄹', url = 'https://t.me/RBBOU'}, 
},
{
{text = 'اضف البوت لمجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'}, 
},
...
data = {
{
{text = '𓄼 مطور السورس 𓄹',type = 'text'},{text = '𓄼 المبرمج viking 𓄹',type = 'text'}
},
{
...
local TestText = "  ❲ 𓄼•ᴅᴇᴠ•𓄹 ❳\n༺┉┉┉⊶﴾𓄼•�ꪮꪊ𝘳ᥴꫀ ꪜ𝓲𝘬𝓲ꪀᧁ•𓄹﴿⊷┉┉┉༻n ⌯*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n⌯ *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id.."&parse_mode=markdown")
end
end
 
if text == '𓄼 مطور السورس 𓄹' or text == 'عسكري' or text == '1234535' or text == 'عسكري تلي' then  
...
if text == '𓄼 المبرمج viking 𓄹' or text == 'viking' or text == 'عبدو' or text == 'مطور السورس' then  
local UserId_Info = LuaTele.searchPublicChat("ttccss")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
if text == '𓄼 المبرمج سيزر 𓄹' or text == 'viking' or text == 'Asaliya' or text == 'عسلية' then  
local UserId_Info = LuaTele.searchPublicChat("AsaliyaEgypt")
if UserId_Info.id then
local  ban = LuaTele.getUser(UserId_Info.id)
local  bain = LuaTele.getUserFullInfo(Sudo_Id)
...
{
{text = '𓄼•جـروب التـيـم•𓄹', url = "https://t.me/FAMILYASALIYA"},{text = '𓄼•قـنـاه الـتـيـم•𓄹', url = "https://t.me/RBBOU"}
},
{
{text = '𓄼•™ʽ𝙏𝙀𝘼𝙈❲𝙏•𝙑❳𝙑𝙄𝙆𝙄𝙉𝙂ʼ•𓄹', url = "https://t.me/FAMILYASALIYA"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
Redis:setex(viking.."viking:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(viking.."viking:Start:Bot") 
...
Redis:set(viking.."viking:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id," ⌯ ارسل الان الكلمه لحذفها من الردود العامه","md",true)  
end
...
Redis:setex(viking.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
⌯ ارسل اذاعتك لتثبيت في الجروبات
⌯ للخروج من الامر ارسل𓄼الغاء𓄹
*]],"md",true)  
...
if not msg.ControllerBot then
if Redis:get(viking.."viking:TwaslBot") and not Redis:sismember(viking.."viking:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(viking.."viking:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(viking.."viking:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(viking..'viking:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ⌯ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(viking..'viking:BaN:In:Tuasl',Info_User)  
...
Redis:srem(viking.."viking:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(viking..'*'..'-100'..data.supergroup.id..'*')
Redis:del(viking.."viking:List:Manager"..'-100'..data.supergroup.id)
Redis:del(viking.."viking:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(viking.."viking:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(viking.."viking:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(viking.."viking:Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(viking) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(viking..'viking:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == viking then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(viking..'viking:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(viking.."viking:Lock:edit"..data.chat_id) then
...
Redis:del(viking.."viking:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(viking.."viking1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(viking.."viking:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(viking.."viking:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(viking.."viking1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(viking.."viking:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(viking.."viking:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(viking.."viking:Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(viking.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*⌯ ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(viking.."zhrfa"..IdUser,"sendzh") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(viking.."viking:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(viking.."viking:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(viking.."viking:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(viking.."viking:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Sasa:Jeka"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(viking.."viking:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(viking.."viking:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(viking.."viking:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(viking.."viking:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(viking..'viking:'..lock..UserId[2],"del")    
end
...
Redis:srem(viking.."viking:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(viking.."viking:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(viking.."viking:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* ⌯ تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(viking.."viking:SilentGroup:Group"..ChatId) 
